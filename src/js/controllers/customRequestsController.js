...
export default function customRequestsController($window, $scope, $injector, stateService, config, $timeout, $filter) {
  ...
  ctrl.hideAllRequests = () => {
    const $els = document.querySelectorAll('prm-location-items .md-list-item-text');
  ...
  ctrl.revealRequest = idx => {
    const $el = document.querySelectorAll('prm-location-items .md-list-item-text')[idx];
  ...
  ctrl.revealCustomRequest = (id, idx) => {
    const $el = document.querySelectorAll(`.custom-request-${id}`)[idx];
  ...
  ctrl.revealNoButtonText = idx => {
    const $el = document.querySelectorAll(`.custom-requests-empty`)[idx];
